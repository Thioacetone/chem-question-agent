...
🔴 题干只能有1句话，不能超过80字！超过80字一律视为包含路线描述！
🔴 题干不能与已知信息(new_info)有任何内容重复！已知信息是题干路线的补充，不是题干内容的复述！
...
{{
  ...
  "stem": "题干（仅一句话，≤80字。只写背景用途+合成路线如下。禁止描述路线步骤！禁止包含任何反应描述！）",
  "questions": [
